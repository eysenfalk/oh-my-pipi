...
export class StatusLineComponent implements Component {
	...
	#planModeStatus: { enabled: boolean; paused: boolean; autoMode?: boolean } | null = null;
	...
	setPlanModeStatus(status: { enabled: boolean; paused: boolean; autoMode?: boolean } | undefined): void {
